...
//        2.5 Verify the text “MacBook”
        verifyElements("Verify the text “MacBook”","MacBook",By.xpath("//h1[normalize-space()='MacBook']"));
//        2.6 Click on ‘Add To Cart’ button
        clickOnElement(By.xpath("//button[@id='button-cart']"));
//        2.7 Verify the message “Success: You have added MacBook to your shopping cart!”
        verifyElements("Verify the message “Success: You have added MacBook to your shopping cart!”","Success: You have added MacBook to your shopping cart!",By.xpath("//div[@class='alert alert-success alert-dismissible']"));
//        2.8 Click on link “shopping cart” display into success message
        clickOnElement(By.xpath("//a[normalize-space()='shopping cart']"));
//        2.9 Verify the text "Shopping Cart"
        verifyElements("Verify the text \"Shopping Cart\"","Shopping Cart",By.xpath("//h1[contains(text(),'Shopping Cart')]"));
//        2.10 Verify the Product name "MacBook"
        verifyElements("Verify the Product name \"MacBook\"","MacBook",By.xpath("//div[@class = 'table-responsive']/table[1]/tbody[1]/tr[1]/td[2]/a[1]"));
...
//        2.13 Verify the message “Success: You have modified your shopping cart!”
        verifyElements("Verify the message “Success: You have modified your shopping cart!”","Success: You have modified your shopping cart!",By.xpath("//div[@class='alert alert-success alert-dismissible']"));
//        2.14 Verify the Total £737.45
        verifyElements("Verify the Total £737.45","£737.45",By.xpath("//div[@class = 'table-responsive']/table[1]/tbody[1]/tr[1]/td[6]"));
//        2.15 Click on “Checkout” button
        clickOnElement(By.xpath("//a[@class='btn btn-primary']"));
//        2.16 Verify the text “Checkout”
        verifyElements("Verify the text “Checkout”","Checkout",By.xpath("//h1[normalize-space()='Checkout']"));
//        2.17 Verify the Text “New Customer”
        verifyElements("Verify the Text “New Customer”","New Customer",By.xpath("//h2[normalize-space()='New Customer']"));
...
//        2.25 Verify the message “Warning: Payment method required!”
        verifyElements("Verify the message “Warning: Payment method required!”","Warning: Payment method required!",By.xpath("//div[@class='alert alert-danger alert-dismissible']"));
    }
