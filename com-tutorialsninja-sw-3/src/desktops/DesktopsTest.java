...
public class DesktopsTest extends Utility {
    ...
    public void verifyProductArrangeInAlphaBaticalOrder() throws InterruptedException {
        ...
        boolean isDecOrderTest = verifyTheListIsDescendingOrder(By.xpath("//h4"));
        verifyElements("Verify the Product will arrange in Descending order", "true", String.valueOf(isDecOrderTest));
    }
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        verifyElements("Verify the Text \"HP LP3065\"","HP LP3065","By.xpath(\"//h1[normalize-space()='HP LP3065']\")");
        ...
        verifyElements("Verify the Message “Success: You have added HP LP3065 to your shopping cart!”","\"Success: You have added HP LP3065 to your shopping cart!\"",By.xpath("//div[@class='alert alert-success alert-dismissible']"));
        ...
        verifyElements("Verify the Product name \"HP LP3065\"","HP LP3065","By.xpath(\"//table[@class = 'table table-bordered']/tbody[1]/tr[1]/td[2]/a[1]\")");
        //2.15 Verify the Delivery Date "2023-11-27"
        verifyElements("Verify the Delivery Date \"2023-11-27\"","Delivery Date:2023-11-28","By.xpath(\"//table[@class = 'table table-bordered']//small[1]\")");
        //2.16 Verify the Model "Product21"
        verifyElements("Verify the Model \"Product21\"","Product 21","By.xpath(\"//td[normalize-space()='Product 21']\")");
        //2.17 Verify the Total "£74.73"
        verifyElements("Verify the Total \"£74.73\"","£74.73","By.cssSelector(\"tbody tr td:nth-child(6)\")");
    }
